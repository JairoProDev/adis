  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (data?.login?.accessToken) {
        ...
        // Also save user data for UI if needed, though context is better
    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-muted/30 px-4 py-12 sm:px-6 lg:px-8">
      <div className="w-full max-w-md space-y-8">
        <div className="flex flex-col items-center text-center">
          ...
          <h2 className="text-3xl font-bold tracking-tight">Ingresa a tu cuenta</h2>
          <p className="mt-2 text-sm text-muted-foreground">
            Publica anuncios, contacta vendedores y gestiona tus favoritos
          </p>
        </div>
