...
let EmailService = EmailService_1 = class EmailService {
    constructor(configService) {
        ...
        this.defaultFrom = this.configService.get('EMAIL_FROM', 'Publicadis <noreply@publicadis.com>');
    }
    ...
    async sendNewListingNotification(to, listingTitle, listingUrl) {
    ...
    async sendMessageNotification(to, senderName, messagePreview, conversationUrl) {
        const html = this.getMessageNotificationTemplate(senderName, messagePreview, conversationUrl);
        return this.sendEmail({
            to,
    ...
    async sendSubscriptionConfirmation(to, planName, amount) {
    ...
    getNewListingTemplate(title, url) {
        return `
      <!DOCTYPE html>
      <html>
        <head>
    ...
    getMessageNotificationTemplate(senderName, preview, url) {
        return `
      <!DOCTYPE html>
      <html>
        <head>
    ...
    getSubscriptionConfirmationTemplate(planName, amount) {
        return `
      <!DOCTYPE html>
      <html>
        <head>
