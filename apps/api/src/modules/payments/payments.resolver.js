...
let PaymentsResolver = class PaymentsResolver {
    ...
    async createCheckoutSession(user, planId, businessId) {
        return this.paymentsService.createCheckoutSession(user.id, planId, businessId);
    }
...
__decorate([
    (0, graphql_1.Mutation)('createCheckoutSession'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __param(1, (0, graphql_1.Args)('planId')),
    __param(2, (0, graphql_1.Args)('businessId', { nullable: true })),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String, String]),
    __metadata("design:returntype", Promise)
], PaymentsResolver.prototype, "createCheckoutSession", null);
__decorate([
    (0, graphql_1.Mutation)('cancelSubscription'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
